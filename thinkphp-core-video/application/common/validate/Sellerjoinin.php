...
//            ['bank_address', 'require', '开户行所在地不能为空'],
        ...
        ['store_name', 'require|length:1,50', '机构名称不能为空|机构名称必须小于50个字'],
        ['storegrade_id', 'require', '机构等级不能为空'],
        ['storeclass_id', 'require', '机构分类不能为空'],
        //sellerjoininc2c
    ...
    protected $scene = [
        ...
        //sellerjoininc2c
        'step2_save_valid2' => ['company_name','company_address_detail','contacts_name','contacts_phone','contacts_email','business_licence_number','business_licence_start','business_licence_end'],
